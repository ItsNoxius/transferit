...
> Vendored from [transferit-py](https://github.com/viperadnan-git/transferit-py)
> (`docs/REVERSE_ENGINEERING.md`, MIT © Adnan Ahmad). Kept here so the TypeScript
> port stays usable if upstream URLs move.
